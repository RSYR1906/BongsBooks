        ...
        >
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-medium text-[#8D8D93] hover:text-[#3D3D45] bg-[#EBEBF0] hover:bg-[#E0E0E5] active:scale-95 transition-all rounded-lg px-3 py-1.5"
            >
              <svg
                width="13"
                height="13"
